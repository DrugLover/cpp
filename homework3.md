...
int main() {
    std::string path("C:/Users/Van/Desktop/1.txt");
...
/* test */
int main() {
    std::string in_path = "C:/Users/Van/Desktop/1.txt";
    std::string out_path = "C:/Users/Van/Desktop/2.txt";
...
- 正确，shared_ptr (p)是对p的一个拷贝，递增p中的计数器，函数运行完之后会被销毁
